    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span><a href="{{url('/collections/{category_slug}/{product_slug}')}}" rel="nofollow">   </a>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-gallery">
                                    ...
                                    <div class="product-image-slider">
                                        <figure class="border-radius-10"></figure>
                                            <img src="{{asset('afrontend_assets/imgs/shop/product-16-2.jpg')}}" alt="product image">
                                        </figure>                                       
                                    </div>
                                    <!-- THUMBNAILS -->
